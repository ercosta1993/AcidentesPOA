...
public class AppTestes {
    ...
    public static void main(String[] args) {
         ...
         */
        //List<Tipo_acidente> tipos = Arrays.asList(Tipo_acidente.ABALROAMENTO, Tipo_acidente.COLISAO);
        ...
        //System.out.println(ger.colecaoAcidentesPorDataTipoAcidente(dataInicial, dataFinal, tipos));
