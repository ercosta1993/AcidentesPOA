...
public class AppTestes {
    ...
    public static void main(String[] args){
         ...
         */
        System.out.println(ger.mapaTipoAcidentesPorRua(LocalDateTime.of(2010, Month.MARCH, 05, 0, 0), LocalDateTime.of(2010, Month.APRIL, 29, 0, 0), Tipo_acidente.COLISAO));
